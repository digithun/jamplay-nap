...
const init = (app, passport) => {
  ...
  providers.forEach(
    ({ provider, Strategy, strategyOptions, getUserFromProfile }) => {
              ...
              NAP.User.findOne(
                ...
                (err, user) => {
                  ...
                  if (req.user) {
                    ...
                    if (req.user.id !== user.id) {
                      return done(
                        require('./errors/codes').AUTH_PROVIDER_ALREADY_LINKED
                      )
                    }
                  } else {
                    ...
                    return NAP.User.findOne(
                      ...
                      (err, user) => {
                        ...
                        if (user) {
                          return done(
                            require('./errors/codes').AUTH_EMAIL_ALREADY_IN_USE
                          )
                        }
