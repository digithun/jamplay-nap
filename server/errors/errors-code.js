...
module.exports = {
  ...
  get AUTH_INVALID_ARGUMENT() { return new GenericError('auth/invalid-argument', 'An invalid argument was provided to an Authentication method. The error message should contain additional information.')},
  get AUTH_INVALID_DISABLED_FIELD() { return new GenericError('auth/invalid-disabled-field', 'The provided value for the disabled user property is invalid. It must be a boolean.')},
  get AUTH_INVALID_DISPLAY_NAME() { return new GenericError('auth/invalid-display-name', 'The provided value for the displayName user property is invalid. It must be a non-empty string.')},
  get AUTH_INVALID_EMAIL_VERIFIED() { return new GenericError('auth/invalid-email-verified', 'The provided value for the emailVerified user property is invalid. It must be a boolean.')},
  get AUTH_INVALID_EMAIL() { return new GenericError('auth/invalid-email', 'The provided value for the email user property is invalid. It must be a string email address.')},
  get AUTH_INVALID_PASSWORD() { return new GenericError('auth/invalid-password', 'The provided value for the password user property is invalid. It must be a string with at least six characters.')},
  get AUTH_INVALID_PHOTO_URL() { return new GenericError('auth/invalid-photo-url', 'The provided value for the photoURL user property is invalid. It must be a string URL.')},
  get AUTH_INVALID_UID() { return new GenericError('auth/invalid-uid', 'The provided uid must be a non-empty string with at most 128 characters.')},
  get AUTH_MISSING_UID() { return new GenericError('auth/missing-uid', 'A uid identifier is required for the current operation.')},
  get AUTH_UID_ALREADY_EXISTS() { return new GenericError('auth/uid-already-exists', 'The provided uid is already in use by an existing user. Each user must have a unique uid.')},
  get AUTH_EMAIL_ALREADY_EXISTS() { return new GenericError('auth/email-already-exists', 'The provided email is already in use by an existing user. Each user must have a unique email.')},
  get AUTH_USER_NOT_FOUND() { return new GenericError('auth/user-not-found', 'There is no existing user record corresponding to the provided identifier.')},
  get AUTH_OPERATION_NOT_ALLOWED() { return new GenericError('auth/operation-not-allowed', 'The provided sign-in provider is disabled for your NAP project. Enable it from the Sign-in Method section of the NAP console.')},
  ...
  get AUTH_PROJECT_NOT_FOUND() { return new GenericError('auth/project-not-found', 'No NAP project was found for the credential used to initialize the Admin SDKs. See Add NAP to your app for documentation on how to generate a credential for your project and use it to authenticate the Admin SDKs.')},
  get AUTH_INSUFFICIENT_PERMISSION() { return new GenericError('auth/insufficient-permission', 'The credential used to initialize the Admin SDK has insufficient permission to access the requested Authentication resource. See Add NAP to your app for documentation on how to generate a credential with appropriate permissions and use it to authenticate the Admin SDKs.')},
  get AUTH_INTERNAL_ERROR() { return new GenericError('auth/internal-error', 'The Authentication server encountered an unexpected error while trying to process the request. The error message should contain the response from the Authentication server containing additional information. If the error persists, please report the problem to our Bug Report support channel.')},
