...
module.exports = {
  ...
  get AUTH_APP_DELETED () {
    return new GenericError(
      'auth/app-deleted',
      'The instance of NAPApp has been deleted.'
    )
  },
  ...
  get AUTH_ARGUMENT_ERROR () {
    return new GenericError(
      'auth/argument-error',
      'A method is called with incorrect arguments.'
    )
  },
  get AUTH_INVALID_API_KEY () {
    return new GenericError(
      'auth/invalid-api-key',
      'The provided API key is invalid. Please check that you have copied it correctly from the NAP Console.'
    )
  },
  ...
  get AUTH_WEB_STORAGE_UNSUPPORTED () {
    return new GenericError(
      ...
      'The browser does not support web storage or if the user disables them.'
    )
  },
