  ...
  <table width="100%" style='${table}'>
    ...
    <tr style='${bodyTableContainer}'>
      <td style='${bodyTableContent}'>
        <div>
          <section style='${sectionConfirmEmail}'>ยืนยันการสมัครสมาชิก</section>
        </div>
        <div>
          <section style='${sectionDetail}'>กรุณากดลิงค์ เพื่อยืนยันตัวตนในการสมัครสมาชิกกับ JamPlay</section>
        </div>
        <div>
          <section style='${sectionVerificationUrl}'>${verification_url}</section>
        </div>
      </td>
    </tr>
  </table>
