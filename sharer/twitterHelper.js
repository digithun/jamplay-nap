...
module.exports.getOAuthRequestToken = ({ consumerKey, consumerSecret, oauth_callback = undefined, force_login = false }) =>
...
module.exports.getAccessToken = ({ oauth_token, oauth_token_secret, oauth_verifier, consumerKey, consumerSecret }) =>
  new Promise((resolve, reject) => {
    let oauth = new OAuth(
      'https://api.twitter.com/oauth/request_token',
      'https://api.twitter.com/oauth/access_token',
